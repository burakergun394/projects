...
public static class PersonelTransportAutomationEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE PersonelTransportAutomationModuleExtensionConfigurator CLASS (in the Domain.Shared project)
